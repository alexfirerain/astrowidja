...
public class Application {
    ...
    private static void welcome() {
        ...
        *********************************
        ...
        """,
                getOrbis(), orbisDivider, edgeHarmonic);
    }
    public static void disableHalfOrbisForDoubles() { halfOrbisForDoubles = false; }
    public static void enableHalfOrbisForDoubles() { halfOrbisForDoubles = true; }
